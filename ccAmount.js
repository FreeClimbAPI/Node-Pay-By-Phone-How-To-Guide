...
router.post('/ccAmountPrompt', (req, res) => {
    ...
    if (customers.has(incoming)) {
        ...
        script = "How much would you like to pay? Just key in the payment amount in US Dollars For example, to make a payment of twenty dollars press two zero, to speak to an agent press zero"
    }
